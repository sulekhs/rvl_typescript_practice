...
import { SentimentRouter } from './routes/detectSentimentRoute';
...
class App{
    ...
    public sentimentRoute: SentimentRouter =  new SentimentRouter();
    ...
    constructor(){
        ...
        this.sentimentRoute.routes(this.app, this.router); 
    }
